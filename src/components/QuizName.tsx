...
export default function QuizName({ profileImg, nickname, title, sex, onClick }: QuizNameProps) {
  return (
    <div
      onClick={onClick}
      className="flex flex-row items-center w-[96.5%] min-h-[149px] max-h-[149px] shadow-xl backdrop-filter backdrop-blur bg-gradient-to-t from-[#7a7a7a1e] to-[#e0e0e024] mx-[0.5%] hover:scale-[101.5%] cursor-pointer rounded-lg my-2"
    >
      <div className="flex flex-col justify-center items-center min-w-[30%] h-full">
